...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  vapor-git = {
    pname = "vapor-git";
    version = "5a301477e4372c24da2df5898606d2729710ead1";
    src = fetchFromGitHub {
      owner = "micheal65536";
      repo = "VapoR";
      rev = "5a301477e4372c24da2df5898606d2729710ead1";
      fetchSubmodules = false;
      sha256 = "sha256-8rHIR1SK+eYvsYOACkH+rnKEa7CVIfWKAeSwbp8PJSw=";
    };
    date = "2025-05-10";
  };
  wayvr-dashboard = {
  ...
  wayvr-dashboard-git = {
    ...
    cargoLock."src-tauri/Cargo.lock" = {
      lockFile = ./wayvr-dashboard-git-ad988f85b9cac247fda40bcb4af290d96cd558b9/src-tauri/Cargo.lock;
      outputHashes = {
        "keyvalues-parser-0.2.0" = "sha256-LT+WHhan/USzW0EOiuIBPG5j1r9qL4n7Z7ESDxO1xQQ=";
        "wayvr_ipc-0.1.0" = "sha256-ieQaY08Ogl/F3t/p825LBp1lAO3SWH1F8206IPXEgTc=";
        "libmonado-1.3.1" = "sha256-HYYfpYhyo5VmbUdwMTJuAR+2dnMITIGZIPGX9Qsnc/g=";
  ...
  wivrn-git = {
    pname = "wivrn-git";
    version = "d1cb25b9c399b0c8fcc84ac8c7af259276ff7868";
    src = fetchFromGitHub {
      owner = "WiVRn";
      repo = "WiVRn";
      rev = "d1cb25b9c399b0c8fcc84ac8c7af259276ff7868";
      fetchSubmodules = false;
      sha256 = "sha256-zRkPp8ZNQynT3XaBCGMMK6yTUk10txSHHJ4trhjcOqo=";
    };
    date = "2025-05-14";
  };
  wivrn-git-monado = {
  ...
  wlx-overlay-s-git = {
    ...
    version = "f85e6088ce73f1d8be8c8236baa86296aa563d81";
    src = fetchFromGitHub {
      owner = "galister";
      repo = "wlx-overlay-s";
      rev = "f85e6088ce73f1d8be8c8236baa86296aa563d81";
      fetchSubmodules = false;
      sha256 = "sha256-+++GDBbFondHz41dBOE1ekzgpRXqvl9IMZU/+7TG8JI=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./wlx-overlay-s-git-f85e6088ce73f1d8be8c8236baa86296aa563d81/Cargo.lock;
      outputHashes = {
  ...
  xrizer-git = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./xrizer-git-fcc6793ffeadf0d7676c4cfd5a6c57da481a520c/Cargo.lock;
      outputHashes = {
        "openxr-0.19.0" = "sha256-mljVBbQTq/k7zd/WcE1Sd3gibaJiZ+t7td964clWHd8=";
      };
    };
