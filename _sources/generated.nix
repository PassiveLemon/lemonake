...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  alcom = {
    ...
    version = "1.1.4-rc.0";
    src = fetchurl {
      url = "https://github.com/vrc-get/vrc-get/releases/download/gui-v1.1.4-rc.0/alcom-1.1.4-rc.0-x86_64.AppImage";
      sha256 = "sha256-qlpMaavYxvdeQAPLvbWPAUxuhz8/XAT6/6QdFWuvfkk=";
    };
  };
  animdl-git = {
    pname = "animdl-git";
  ...
  webfisher = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.3.1";
      fetchSubmodules = false;
      sha256 = "sha256-VlYFepmGkqPlNe806s9z+/TKUwmNYf3PWYwV3KiQa4A=";
    };
  };
  webfisher-git = {
    pname = "webfisher-git";
    version = "59fa9c8f5cd12717bfd39ad7da5ab24b71b42eb3";
    src = fetchFromGitHub {
      owner = "PassiveLemon";
      repo = "webfisher";
      rev = "59fa9c8f5cd12717bfd39ad7da5ab24b71b42eb3";
      fetchSubmodules = false;
      sha256 = "sha256-cghLWQ1DZa9sxesDFN/5vvM+zrrVoikKqRI/s5XhCq0=";
    };
    date = "2025-08-22";
  };
  wivrn = {
  ...
  wivrn-git = {
    pname = "wivrn-git";
    version = "9f2aa0157c99e93b4d21877cd89bcfa8d22fb4a1";
    src = fetchFromGitHub {
      owner = "WiVRn";
      repo = "WiVRn";
      rev = "9f2aa0157c99e93b4d21877cd89bcfa8d22fb4a1";
      fetchSubmodules = false;
      sha256 = "sha256-FgSfN17I2zcvnO4p2bxVz6zsoSdB/IWHvud2r/kFOeA=";
    };
    date = "2025-08-26";
  };
  wivrn-git-monado = {
  ...
  xrizer-git = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./xrizer-git-072476c7fa5f090ee0e8f6a376d4907288e36252/Cargo.lock;
      outputHashes = {
        "openxr-0.19.0" = "sha256-mljVBbQTq/k7zd/WcE1Sd3gibaJiZ+t7td964clWHd8=";
      };
    };
