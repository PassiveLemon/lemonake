...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  wayvr-dashboard = {
    ...
    cargoLock."src-tauri/Cargo.lock" = {
      lockFile = ./wayvr-dashboard-0.3.5/src-tauri/Cargo.lock;
      outputHashes = {
  ...
  wayvr-dashboard-appimage = {
    ...
    version = "0.3.5";
    src = fetchurl {
      url = "https://github.com/olekolek1000/wayvr-dashboard/releases/download/0.3.5/wayvr-dashboard.AppImage";
      sha256 = "sha256-ak/vZ9SXpsOroBxFDffE23X8YZkPnI1YKvbG8XshNB0=";
    };
  };
  wayvr-dashboard-git = {
    ...
    cargoLock."src-tauri/Cargo.lock" = {
      lockFile = ./wayvr-dashboard-git-dad0b13389def4b6e8b8cdf212bcfcd314f19472/src-tauri/Cargo.lock;
      outputHashes = {
        "keyvalues-parser-0.2.0" = "sha256-LT+WHhan/USzW0EOiuIBPG5j1r9qL4n7Z7ESDxO1xQQ=";
        "wayvr_ipc-0.1.0" = "sha256-ieQaY08Ogl/F3t/p825LBp1lAO3SWH1F8206IPXEgTc=";
        "libmonado-1.3.1" = "sha256-HYYfpYhyo5VmbUdwMTJuAR+2dnMITIGZIPGX9Qsnc/g=";
  ...
  wlx-overlay-s-git = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./wlx-overlay-s-git-9dceaf30e54baed2d89686c6b03951cfd7ae5a7e/Cargo.lock;
      outputHashes = {
  ...
  xrizer-git = {
    pname = "xrizer-git";
    version = "49bd80e23156f41b9d851e88a3d950b545633c39";
    src = fetchFromGitHub {
      owner = "Supreeeme";
      repo = "xrizer";
      rev = "49bd80e23156f41b9d851e88a3d950b545633c39";
      fetchSubmodules = false;
      sha256 = "sha256-rl2Ysc0YyJjLpeFhBZq+F5FzeQiherzRowtvTRP4tWI=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./xrizer-git-49bd80e23156f41b9d851e88a3d950b545633c39/Cargo.lock;
      outputHashes = {
        "openxr-0.19.0" = "sha256-mljVBbQTq/k7zd/WcE1Sd3gibaJiZ+t7td964clWHd8=";
      };
    };
