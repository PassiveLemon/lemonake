...
}:
{
  alcom-git = {
    pname = "alcom-git";
    version = "14265beb11698866eac08d441301240b8a8896bf";
    src = fetchFromGitHub {
      owner = "vrc-get";
      repo = "vrc-get";
      rev = "14265beb11698866eac08d441301240b8a8896bf";
      fetchSubmodules = false;
      sha256 = "sha256-uVUoLsvl4MW5Ox9FXwjNilC/U64gtnWzg4DEZ5KqGNc=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-uVUoLsvl4MW5Ox9FXwjNilC_U64gtnWzg4DEZ5KqGNc=/Cargo.lock";
      outputHashes = {
  ...
  hilbish-midnight = {
    ...
    version = "0c13e81c5da221c36650f9f68d4296e78cdb26fd";
    src = fetchFromGitHub {
      owner = "sammy-ette";
      repo = "Hilbish";
      rev = "0c13e81c5da221c36650f9f68d4296e78cdb26fd";
      fetchSubmodules = true;
      sha256 = "sha256-xLhtft7fp8l9NA9iYq3pZsoiofVHski2L3HRo0ymA2c=";
    };
    date = "2026-06-20";
  };
  lite-xl-git = {
