...
}:
{
  ...
  hilbish-git = {
    pname = "hilbish-git";
    version = "bb1c0ac58bcee5e3973ae298f43d23010e7eb9a0";
    src = fetchFromGitHub {
      owner = "sammy-ette";
      repo = "Hilbish";
      rev = "bb1c0ac58bcee5e3973ae298f43d23010e7eb9a0";
      fetchSubmodules = true;
      sha256 = "sha256-0IffoxGKAhTD2+iQKCaDQ9Ryesy/5gRk1Jexk6dzqs8=";
    };
    date = "2026-09-16";
  };
  lite-xl-git = {
  ...
  somewm-git = {
    pname = "somewm-git";
    version = "cf539237c9429dd4437d5f476cb639a2bd76e664";
    src = fetchFromGitHub {
      owner = "trip-zip";
      repo = "somewm";
      rev = "cf539237c9429dd4437d5f476cb639a2bd76e664";
      fetchSubmodules = false;
      sha256 = "sha256-o4ufJs50b65NjQ7jp2e18iqKnSHuSY89RE0620JL4OI=";
    };
    date = "2026-09-09";
  };
  tilibs-git = {
