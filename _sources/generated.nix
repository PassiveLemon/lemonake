...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  alvr-git = {
    pname = "alvr-git";
    version = "3a060d3c6ec3e246b9933187bf4bf929dfc0ea40";
    src = fetchFromGitHub {
      owner = "alvr-org";
      repo = "ALVR";
      rev = "3a060d3c6ec3e246b9933187bf4bf929dfc0ea40";
      fetchSubmodules = true;
      sha256 = "sha256-Ku28S3hSrMi/v4xXLBYAimVCdHKcdUW4vawlsbv7NNI=";
    };
    date = "2024-12-08";
  };
  animdl-git = {
  ...
  wivrn-git = {
    pname = "wivrn-git";
    version = "258150967c136c57265f909d1e7491a0a366d599";
    src = fetchFromGitHub {
      owner = "WiVRn";
      repo = "WiVRn";
      rev = "258150967c136c57265f909d1e7491a0a366d599";
      fetchSubmodules = false;
      sha256 = "sha256-cZA/4f5Zhh7B7XbPw4VL4kfVylhHSCmxxcp2OizpdMs=";
    };
    date = "2024-12-09";
  };
  wivrn-git-monado = {
