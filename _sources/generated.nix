...
}:
{
  ...
  awesome-git = {
    pname = "awesome-git";
    version = "994f9d6ed531a7f2fdc0c0cde16a678f7d317a0a";
    src = fetchFromGitHub {
      owner = "awesomeWM";
      repo = "awesome";
      rev = "994f9d6ed531a7f2fdc0c0cde16a678f7d317a0a";
      fetchSubmodules = false;
      sha256 = "sha256-yNY/tEpLwPDtEr8nzMNfdOW8+pKBLYINyfkLu4XBYKg=";
    };
    date = "2026-04-08";
  };
  gdlauncher-carbon = {
  ...
  proton-ge-rtsp = {
    ...
    src = fetchTarball {
      url = "https://github.com/SpookySkeletons/proton-ge-rtsp/releases/download/GE-Proton10-33-rtsp22/GE-Proton10-33-rtsp22-4.tar.gz";
      sha256 = "sha256-YmdO4XaEFbq1lWWorZMqFKVQb+bMxDDH/dpwKaq+Qjg=";
    };
  };
  somewm = {
    pname = "somewm";
  ...
  somewm-git = {
    pname = "somewm-git";
    version = "fb7414672e0bcd9821d01377e1220ede9414afeb";
    src = fetchFromGitHub {
      owner = "trip-zip";
      repo = "somewm";
      rev = "fb7414672e0bcd9821d01377e1220ede9414afeb";
      fetchSubmodules = false;
      sha256 = "sha256-X+v+ChxZPlYdLrjEnVY4j4cq0cV3/e+DoB6H7Zwv7i8=";
    };
    date = "2026-04-10";
  };
  tilp2-gfm = {
  ...
  wivrn-git = {
    pname = "wivrn-git";
    version = "6db5b8aeb3817ff627f54c294a2ce46f29826540";
    src = fetchFromGitHub {
      owner = "WiVRn";
      repo = "WiVRn";
      rev = "6db5b8aeb3817ff627f54c294a2ce46f29826540";
      fetchSubmodules = false;
      sha256 = "sha256-ipsZ7YmgESCweWuP4YyfDryc/tAuPmt9xKCVqVzYNb4=";
    };
    date = "2026-04-10";
  };
  wivrn-git-monado = {
