...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  wivrn-git = {
    pname = "wivrn-git";
    version = "f3c652c029e17c5ce15fee396f1db7a29afd9d73";
    src = fetchFromGitHub {
      owner = "WiVRn";
      repo = "WiVRn";
      rev = "f3c652c029e17c5ce15fee396f1db7a29afd9d73";
      fetchSubmodules = false;
      sha256 = "sha256-ex0wT4NvG/4FVpDSD9k6+EiQ8dBqNkG8yJJcKpP5Kws=";
    };
    date = "2025-01-25";
  };
  wivrn-git-monado = {
    pname = "wivrn-git-monado";
    version = "529aa5b092b592714812b4685aa0454a3cfb120e";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/monado/monado.git";
      rev = "529aa5b092b592714812b4685aa0454a3cfb120e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-h3b6mPOlbMpzXYzNrRdebRWvj1ovATMFHZtxaGDpzFc=";
    };
  };
  wivrn-monado = {
    pname = "wivrn-monado";
  ...
  xrizer-git = {
    pname = "xrizer-git";
    version = "2c41eeb1b90c35d62bcf25816a957698c8cb27f5";
    src = fetchFromGitHub {
      owner = "Supreeeme";
      repo = "xrizer";
      rev = "2c41eeb1b90c35d62bcf25816a957698c8cb27f5";
      fetchSubmodules = false;
      sha256 = "sha256-1oKRWvuh0gDKT55uoALP1+RN1JBFBRmmYFk8/XbxEmM=";
    };
    date = "2025-01-25";
  };
}
