...
}:
{
  ...
  picom-git = {
    pname = "picom-git";
    version = "d68c3041424f02b3cfe5c666b1a7a9a36ffe67fe";
    src = fetchFromGitHub {
      owner = "yshui";
      repo = "picom";
      rev = "d68c3041424f02b3cfe5c666b1a7a9a36ffe67fe";
      fetchSubmodules = false;
      sha256 = "sha256-TDEunxH6I0I66I2kJ92RC82nDpLkEeRxaBhFOkVKGqE=";
    };
    date = "2025-12-08";
  };
  picom-tag = {
  ...
  xrizer-git = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-_ArIDn8vX8igyDoJTppVN4fo8jr+kyrjVK4zPVadlX8=/Cargo.lock";
      outputHashes = {
        "openxr-0.19.0" = "sha256-mljVBbQTq/k7zd/WcE1Sd3gibaJiZ+t7td964clWHd8=";
      };
    };
